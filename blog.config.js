...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Dororo', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一切在文字中', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'dororodoujo.com', // 网站地址
