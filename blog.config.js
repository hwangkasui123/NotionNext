...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'dororo有几何', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '敏感肌，天天想法子摸鱼打游戏', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://dororodoujo.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '文字，博客，知识分享', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是敏感肌, 我爱写黄文,欢迎来到我的博客🎉',
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-4447620039918417', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
